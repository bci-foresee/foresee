// abits are number of address bits (ie how many addresses can be stored in fifo)
//dbits are how many bits at each address
// wr is the signal that tells the fifo to write
// rd is the signal that tells the fifo to read
