...
class patient_data_info:
    ...
    def gen_indices(self, file_idx_len=1843200, offset_beg = 0, offset_end = 0):
        ...
        for i in range(len(self.seizure_begin)):
            ...
            self.seizure_start_files[i] = start_file_num - 1
        ...
        for i in range(len(self.seizure_begin)):
            overall_end_idx = np.ceil(self.seizure_begin[i] * self.sample_rate[0][0]) - offset_beg
            print(self.seizure_begin[i], self.sample_rate[0][0], self.seizure_begin[i] * self.sample_rate[0][0])
            ...
            self.seizure_end_files[i] = end_file_num - 1
...
print('\n')
print(patient_dict['16'].seizure_end)

print('\n')
patient_dict['16'].gen_indices()
print(patient_dict['16'].seizure_start_files)
print('\n')
print(patient_dict['16'].seizure_end_files)
